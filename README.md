...
.Estudando com foco em Java Web 🚀☕️
    ...
    .stat {
      font: 600 14px 'Segoe UI', Ubuntu, "Helvetica Neue", Sans-Serif; fill: #E1E1E6;
    }
    .stagger {
      opacity: 0;
    ...
    .rank-text {
      font: 800 24px 'Segoe UI', Ubuntu, Sans-Serif; fill: #E1E1E6; 
    ...
    @keyframes rankAnimation {
      ...
      to {
        stroke-dashoffset: 123.63005935751879;
      }
    }
    ...
    @keyframes fadeInAnimation {
      ...
      <text
        ...
        class="header"
        data-testid="header"
      >Caio Macedo's GitHub Stats</text>
    </g>
      </g>
